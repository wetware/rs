//! End-to-end integration test: HttpServer + BoundExecutor + echo handler.
//!
//! Validates the full pipeline:
//!   1. Load echo-handler WASM binary
...
const ECHO_WASM: &[u8] = include_bytes!("echo-handler/bin/echo_handler.wasm");
